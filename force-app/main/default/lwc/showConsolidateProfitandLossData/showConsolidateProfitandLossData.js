...
export default class ShowConsolidateProfitandLossData extends LightningElement {
    // customLabel = {
    ...
    handleLoanIdChange(value){
        ...
        tempParams.queryCriteria = ' where Loan_Applicant__r.LoanAppln__c = \'' + this.loanAppId + '\'' + ' AND RecordType.Name = \'Profit & Loss\''
    ...
    summarizedData(wrapConsData1) {
        ...
        financialData.forEach(record => {
            ...
            groupedData[year].Total_Sales__c += record.Total_Sales__c;
            groupedData[year].Other_Operating_Income_IncomeIncidental__c += record.Other_Operating_Income_IncomeIncidental__c;
            groupedData[year].ExportSalesOutOfAboveSales__c += record.ExportSalesOutOfAboveSales__c;
            groupedData[year].Non_Operating_Income__c += record.Non_Operating_Income__c;
            ...
            groupedData[year].Gross_Profit__c += record.Gross_Profit__c;
            ...
            groupedData[year].EBITDA__c += record.EBITDA__c;
            ...
            groupedData[year].Profit_Before_Depreciation_and_Tax_PBDT__c += record.Profit_Before_Depreciation_and_Tax_PBDT__c;
            groupedData[year].Depreciation__c += record.Depreciation__c;
            groupedData[year].Profit_Before_Tax__c += record.Profit_Before_Tax__c;
            groupedData[year].Taxes__c += record.Taxes__c;
            groupedData[year].PAT__c += record.PAT__c;
            groupedData[year].Director_Partners_remuneration_Interest__c += record.Director_Partners_remuneration_Interest__c;
            groupedData[year].Tax_on_Above_Income__c += record.Tax_on_Above_Income__c;
            groupedData[year].Net_Income_Considered_for_Eligibility__c += record.Net_Income_Considered_for_Eligibility__c;
            
            groupedData[year].Income_addition_u_s_40_a_2_b__c += record.Income_addition_u_s_40_a_2_b__c;
            groupedData[year].Tax_on_the_above_inc_for_Addition__c += record.Tax_on_the_above_inc_for_Addition__c;
            groupedData[year].Net_inc_con_for_Eligibility_for_add_Inc__c += record.Net_inc_con_for_Eligibility_for_add_Inc__c;
