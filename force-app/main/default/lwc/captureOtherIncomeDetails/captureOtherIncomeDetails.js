...
//Custom labels
import OtherIncome_Save_SuccessMessage from '@salesforce/label/c.OtherIncome_Save_SuccessMessage';
...
import Other_Income_Details_Deleted_Success from '@salesforce/label/c.Other_Income_Details_Deleted_Success';

export default class CaptureOtherIncomeDetails extends LightningElement {
    label = {
        OtherIncome_Save_SuccessMessage,
        ...
        Other_Income_Details_Deleted_Success
    }
    ...
    handleDeleteAction(event) {
        ...
        //         .then(() => {
        //             this.showToastMessage("Success", this.label.OtherIncome_Save_SuccessMessage, "success", "dismissible");
        ...
        if (this.recordDelId) {
            ...
            .then(result => {
               ...
               this.showToastMessage("Success", this.label.Other_Income_Details_Deleted_Success, "success", "dismissible");
               this.showDeleteConfirmation = false;
               refreshApex(this.wiredData);
            })
            .catch(error => {
