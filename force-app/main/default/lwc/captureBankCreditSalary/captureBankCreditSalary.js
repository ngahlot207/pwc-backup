...
export default class CaptureBankCreditSalary extends LightningElement {
    ...
    bankCreditSalaryHeaders = [
        ...
        { 'key': 9, 'columnName': 'Bank Credit Date', 'required': true, 'style': "min-width: 12rem;display:flex;" },
        { 'key': 10, 'columnName': 'Remarks', 'style': "min-width: 12rem;display:flex;" },
