...
export default class RcuDocumentPreviewer extends LightningElement {
    ...
    contentVerRecords(listOfContentDocumentIds){
        ...
        .then((data) => {
            ...
            for(const record of this.parentRecsOfConVer){
                let DocIdExtTypeObj={"contDocType":record.FileExtension, "contDocId":record.ContentDocumentId, "Id":record.Id}
