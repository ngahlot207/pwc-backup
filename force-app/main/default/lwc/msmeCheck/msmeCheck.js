    ...
    loanEmpData(result) {
       // const { data, error } = wiredLoanEmpData;
        ...
        if (result.data) {
            ...
            this.MSMERecords = []
            this.RBIRecords = []
            console.log(" result of loan in emp data"+JSON.stringify(result.data))
            this.EmpParentRecord=result.data;   
           // this.EmpParentRecord=JSON.parse(JSON.stringify(data));           
            //this.EmpChildRecord=JSON.parse(JSON.stringify(data[0].ChildReords));
            //console.log('industry value', this.EmpChildRecord.IndustryType__c);
            
          // console.log('length of emp', this.EmpParentRecord[0].parentRecord.ApplType__c);
           ...
           for(var i=0;i< this.EmpParentRecord.length;i++){
            ...
            let MSMERecordObj={}
                    ...
                    if(this.EmpParentRecord[i].parentRecord.Constitution__c!='INDIVIDUAL' || 
                        ...
                        ( this.EmpParentRecord[i].parentRecord.Constitution__c=='PROPERITORSHIP' && 
